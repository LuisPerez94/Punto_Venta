 ...
 * @author JR
 */
public class OyenteEliminarCliente implements ActionListener, KeyListener{
    Conexion c ;
    EliminarCliente mc;

    public OyenteEliminarCliente(Conexion c, EliminarCliente mc) {
        this.c = c;
        this.mc = mc;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        switch(e.getActionCommand()){
            ...
            try {
                ...
                Logger.getLogger(OyenteEliminarCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
                    mc.dispose();
