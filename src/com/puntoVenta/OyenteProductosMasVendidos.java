...
/**
 * @author Fernando2 Created on Dec 30, 2014, 6:01:58 PM
 */
public class OyenteProductosMasVendidos extends WindowAdapter implements ActionListener {
    ...
    public OyenteProductosMasVendidos(PanelProductosMasVendidos panel, Conexion conexion, String opcion) {
        bpmv = null;
        this.panel = panel;
...
//        System.out.println("Query: " + query);
    ...
    public void productosMasVendidos(String opcion) throws SQLException {
        correcto = true;
        String consulta;
        switch (opcion) {
            case 
                "masVendidos"
                :
         consulta = "Select * from ProductoMasVendidos";
                ...
                try {
                    ...
                    while (conexion.getResult().next()) {
                        Object[] fila = new Object[conexion.getResult().getMetaData().getColumnCount()];
                    ...
                    panel.getProductos().getColumnModel().getColumn(1).setCellRenderer(tcr);
                    panel.getProductos().getColumnModel().getColumn(2).setCellRenderer(tcr);
            ...
            case "ventasXVendedor":
               consulta = "Select * from vendedores_mas_ventas";
